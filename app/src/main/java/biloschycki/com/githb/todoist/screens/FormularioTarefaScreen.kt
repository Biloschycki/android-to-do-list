package biloschycki.com.githb.todoist.screens
...
import biloschycki.com.githb.todoist.util.combinarDataHora
import biloschycki.com.githb.todoist.util.extrairDataDoDatePicker
import biloschycki.com.githb.todoist.util.paraMillisUtcDoDatePicker
...
fun FormularioTarefaScreen(
    ...
    FormularioTarefaContent(
        ...
        onSalvar = { titulo, descricao, dataHora ->
            if (tarefaId == 0) {
                viewModel.inserir(Tarefa(titulo = titulo, descricao = descricao, dataHora = dataHora))            } else {
                tarefaExistente?.let {
